...
class MedpikImageAssets {
  ...
  static const String offerGradientBlue =
      '$_base/Messhu Flow (Speed_ 0.49).png';
  static const String offerGradientOrange =
      '$_base/Messhu Flow (Speed_ 0.32).png';
  static const String offerGradientPink =
      '$_base/Messhu Flow (Speed_ 0.28).png';
