...
String _$authRepositoryHash() => r'5809462650f6061506af88dc46f9d4ed1034ff88';

/// See also [authRepository].
@ProviderFor(authRepository)
final authRepositoryProvider = AutoDisposeProvider<AuthRepo>.internal(
  authRepository,
...
final homeRepositoryProvider = AutoDisposeProvider<HomeRepo>.internal(
  homeRepository,
...
final searchRepositoryProvider = AutoDisposeProvider<SearchRepo>.internal(
  searchRepository,
...
final productDetailRepositoryProvider =
    AutoDisposeProvider<ProductDetailRepo>.internal(
...
final addressRepositoryProvider = AutoDisposeProvider<AddressRepo>.internal(
  addressRepository,
...
final checkoutRepositoryProvider = AutoDisposeProvider<CheckoutRepo>.internal(
  checkoutRepository,
...
final ordersRepositoryProvider = AutoDisposeProvider<OrdersRepo>.internal(
  ordersRepository,
